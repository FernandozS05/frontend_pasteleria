            ...
            <div class="col-auto mt-3">
                <div class="p-3 border border-3 rounded-4">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="tipoEntrega" id="entregaSucursal"
                            value="sucursal" v-model="tipoEntrega" />
                        <label class="form-check-label" for="entregaSucursal">
                            Sucursal: Calle principal #5, Col.Prueba, Xalapa, Ver.
                        </label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="tipoEntrega" id="entregaDomicilio"
                            value="domicilio" v-model="tipoEntrega" />
                    ...
                    <select v-model="fechaSeleccionada" class="form-select" @change="consultarAgenda">
                        ...
                        <option v-for="fechaDisponible in fechasDisponibles" :key="fechaDisponible"
