  ...
  <div class="row">
    ...
    <div class="row mt-3 border rounded border-4">
      <div class="row">
        ...
        <div class="col-6 mt-3">
          <h4>Ventas ultimas 4 semanas</h4>
...
export default {
  ...
  methods: {
    ...
    actualizarGraficas() {
      ...
      if (this.graficas.ventasPorSemestre) {
        this.graficas.ventasPorSemestre.destroy();
      ...
      if (this.graficas.ventasPorSemana1) {
        this.graficas.ventasPorSemana1.destroy();
        this.graficas.ventasPorSemana1 = null;
        this.graficas.ventasPorSemana1 = new Chart(document.getElementById('ventasPorSemana1').getContext('2d'), {
          type: 'doughnut',
          data: {
            labels: this.datos.ventasPorSemana1.map(item => item.dia),
            datasets: [{
              label: 'Ventas por la semana 1',
              data: this.datos.ventasPorSemana1.map(item => item.total),
              borderWidth: 1
            }]
          },
          options: {
      ...
      if (this.graficas.ventasPorSemana2) {
        this.graficas.ventasPorSemana2.destroy();
        this.graficas.ventasPorSemana2 = null;
        this.graficas.ventasPorSemana2 = new Chart(document.getElementById('ventasPorSemana2').getContext('2d'), {
          type: 'doughnut',
          data: {
            labels: this.datos.ventarPorSemanas[1].labels.map(dia => dia),
      ...
      if (this.graficas.ventasPorSemana3) {
        this.graficas.ventasPorSemana3.destroy();
        this.graficas.ventasPorSemana3 = null;
        this.graficas.ventasPorSemana3 = new Chart(document.getElementById('ventasPorSemana3').getContext('2d'), {
          type: 'doughnut',
          data: {
            labels: this.datos.ventarPorSemanas[2].labels.map(item => item),
      ...
      if (this.graficas.ventasPorSemana4) {
        this.graficas.ventasPorSemana4.destroy();
        this.graficas.ventasPorSemana4 = null;
        this.graficas.ventasPorSemana4 = new Chart(document.getElementById('ventasPorSemana4').getContext('2d'), {
          type: 'doughnut',
          data: {
            labels: this.datos.ventarPorSemanas[3].labels.map(item => item),
      ...
      if (this.graficas.ventasPorTipoMes) {
        this.graficas.ventasPorTipoMes.destroy();
      ...
      if (this.graficas.ventasPorProductoMes) {
        this.graficas.ventasPorProductoMes.destroy();
      ...
      if (this.graficas.insumosVsConsumidosMes) {
        this.graficas.insumosVsConsumidosMes.destroy();
      ...
      this.graficaSemanaSeleccionada = "Semana1"
    },
    calcularInicioSemana(fecha, semana) {
      // Parsear la fecha si aún no es un objeto moment
      let momento = moment(fecha).subtract(4, "weeks");
      // Establecer al inicio de la semana (lunes como el inicio de la semana)
