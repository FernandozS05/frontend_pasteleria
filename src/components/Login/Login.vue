    ...
    <div class="row">
      ...
      <div class="col-md-6 order-md-1 mt-5">
        <div class="gradient-background p-3">
          <div class="mb-3">
            <img src="../../assets/Logo1.png" alt="Logotipo Pastelería Zudey" class="img-fluid logo" />
          </div>
          ...
          <form @submit.prevent="iniciarSesion">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
              <button type="submit" class="btn btn-rose">Iniciar Sesión</button>
              <router-link to="/registro" class="text-rose">¿No tienes una cuenta? Registrarse</router-link>
            </div>
          </form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    iniciarSesion() {
      ...
      const url = api.login;
      const datos = (this.tipo === "cliente") ? { email: this.usuario, contrasenia: this.contrasenia} : { nombreUsuario: this.usuario, contraseña: this.contrasenia };
      console.log(url);
